  ...
  return (
   <>
    ...
    <div className='bg-gray-100 px-10 min-h-screen'>
      ...
      <div className="mx-auto px-10 bg-gray-100 pt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div className="flex flex-col bg-gray-100 rounded">
                <div className="flex items-center justify-between p-3 bg-gray-100 rounded">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="block font-medium text-gray-800">Passport</span>
              ...
              <div className="flex items-center justify-between p-3 bg-gray-100 rounded">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="block font-medium text-gray-800">IELTS Score</span>
                      <span className="text-sm text-gray-500">2023-12-20</span>
                    </div>
                  </div>
                  <div className="text-sm font-semibold mb-6">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-100 rounded">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="block font-medium text-gray-800">SOP</span>
                      <span className="text-sm text-gray-500">2023-12-20</span>
                    </div>
                  </div>
                  <div className="text-sm font-semibold mb-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-semibold">Linked Agent</h2>
            </div>
