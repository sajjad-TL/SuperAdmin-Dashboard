          ...
          <div className="bg-white rounded-lg shadow p-6 flex-1">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* Bank Transfer */}
                <div 
                  className={`border rounded-md p-4 cursor-pointer hover:border-blue-500 ${paymentMethod === 'bank' ? 'border-blue-500 bg-blue-50' : 'border-gray-300'}`}
                ...
                {/* PayPal */}
                <div 
                  className={`border rounded-md p-4 cursor-pointer hover:border-blue-500 ${paymentMethod === 'paypal' ? 'border-blue-500 bg-blue-50' : 'border-gray-300'}`}
                ...
                {/* Wire Transfer */}
                <div 
                  className={`border rounded-md p-4 cursor-pointer hover:border-blue-500 ${paymentMethod === 'wire' ? 'border-blue-500 bg-blue-50' : 'border-gray-300'}`}
            ...
            <div>
              <h2 className="text-lg font-medium text-gray-900 mb-4">Payment Description</h2>
              <textarea
                value={description}
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium">#PR20250503</span>
                </div>
                
                <div className="flex justify-between">
                  <span className="text-sm text-gray-600">Date</span>
                  <span className="text-sm font-medium">May 7, 2025</span>
                </div>
                
                <div className="flex justify-between">
                  <span className="text-sm text-gray-600">Status</span>
                  <span className="text-xs font-medium bg-yellow-100 text-yellow-800 py-1 px-2 rounded-full">Draft</span>
                </div>
                
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex justify-between mb-2">
                    <span className="text-sm text-gray-600">Subtotal</span>
                    <span className="text-sm font-medium">${amount || '0.00'}</span>
                  </div>
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-700">
                    All payments are subject to review and approval. 
                    Processing times may vary based on the selected payment method.
                  </p>
                </div>
              </div>
            </div>
